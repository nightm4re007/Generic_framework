...
@CucumberOptions(
		...
		features = "src/test/java/com/automation/features/placeValidations.feature", glue = { "com/automation/stepdefinitions" }, plugin = {
				"pretty", "json:target/cucumber-reports/Cucumber.json", "junit:target/cucumber-reports/Cucumber.xml",
				"html:target/cucumber-reports",
				"com.cucumber.listener.ExtentCucumberFormatter:","rerun:rerun/placeFailed.txt" },monochrome = true)
public class placeRunner extends testbase{
	...
	{//
		...
		//init();
		testNGCucumberRunner = new TestNGCucumberRunner(placeRunner.class);
